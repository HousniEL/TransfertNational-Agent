...
export class AddBeneficiaryComponent implements OnInit, AfterViewInit {
  ...
  constructor(private formBuilder : FormBuilder, private mainComponent : MainComponent 
            ,private agentServ : AgentService , private transferT : TransferService) {

      this.request_by_prospect_client=this.transferT.multiTransfer.request_by_prospect_client;
